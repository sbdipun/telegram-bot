...
async def start(_, message):
    ...
    await message.reply_text(f"Hi! I Am IMDB Bot. Send movie/Series Name After /imdb")


@app.on_message(filters.command("imdb") & filters.text)
...
@app.on_callback_query(filters.regex(r'^imdb'))  # Filter for 'imdb' callbacks
...
app.add_handler(MessageHandler(imdb_search,))
